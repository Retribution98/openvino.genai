...
Napi::Function WhisperPerfMetricsWrapper::get_class(Napi::Env env) {
    ...
    properties.push_back(InstanceMethod("getFeaturesExtractionDuration",
                                       &WhisperPerfMetricsWrapper::get_features_extraction_duration));
    properties.push_back(
        InstanceMethod("getWordLevelTimestampsProcessingDuration",
                      &WhisperPerfMetricsWrapper::get_word_level_timestamps_processing_duration));
    properties.push_back(
        InstanceAccessor<&WhisperPerfMetricsWrapper::get_whisper_raw_metrics>("whisperRawMetrics"));
    ...
    obj.Set("featuresExtractionDurations",
            cpp_to_js<std::vector<float>, Napi::Value>(
                ...
                get_ms(_metrics.whisper_raw_metrics,
                       &ov::genai::WhisperRawPerfMetrics::features_extraction_durations)));
